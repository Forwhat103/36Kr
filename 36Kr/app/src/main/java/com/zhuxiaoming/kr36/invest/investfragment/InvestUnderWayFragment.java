 ...
 */
public class InvestUnderWayFragment extends BaseFragment {
    ...
    protected void initData() {
        investLv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(context, "别点了,跳不动了", Toast.LENGTH_SHORT).show();
            }
        });


        VolleySingle.addRequest("https://rong.36kr.com/api/mobi/cf/actions/list?page=1&type=" + types[1] + "&pageSize=20", InvestBean.class,
